        ...
        <div class="space-y-5 animate-fade-in-up">
          ...
          @if (c.fraudFlags?.length) {
            <div class="glass-card-static p-6">
              ...
              <a [routerLink]="'/fraud/correlations/' + c.claimId" class="btn-ghost text-xs mt-4 inline-flex items-center gap-1.5"
                 aria-label="View fraud correlations for this claim">
