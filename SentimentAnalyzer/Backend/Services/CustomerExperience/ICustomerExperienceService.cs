...
public interface ICustomerExperienceService
{
    ...
    Task<CustomerExperienceResponse> ChatAsync(string message, string? claimContext = null, CancellationToken ct = default);
    ...
    IAsyncEnumerable<CustomerExperienceStreamChunk> StreamChatAsync(string message, string? claimContext = null, CancellationToken ct = default);
}
