...
/// </summary>
public record GetFraudAlertsQuery(double MinFraudScore = 55, int PageSize = 50) : IRequest<List<ClaimTriageResponse>>;

/// <summary>
/// Handler that loads fraud alerts from the repository.
/// </summary>
public class GetFraudAlertsHandler : IRequestHandler<GetFraudAlertsQuery, List<ClaimTriageResponse>>
{
    ...
    public async Task<List<ClaimTriageResponse>> Handle(GetFraudAlertsQuery query, CancellationToken cancellationToken)
    {
